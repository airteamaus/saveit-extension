...
export function createSavedPagesDrawerController({
  ...
  function initDrawerEventHandlers() {
    initSavedPagesDrawerEventsFn({
      ...
      handleFeedEditStart: (id) => feedController?.handleEditStart(id),
      handleFeedEditCancel: () => feedController?.handleEditCancel(),
      handleFeedEditSubmit: (id, fields) => feedController?.handleEditSubmit(id, fields),
      handleFeedPin: (id) => feedController?.handlePin(id),
      handleFeedProjects: (id) => feedController?.handleProjects(id),
      handleFeedDelete: (id) => feedController?.handleDelete(id),
