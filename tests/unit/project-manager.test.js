...
describe('ProjectManager', () => {
  ...
  beforeEach(() => {
    ...
    dashboard = {
      ...
      projects: [
        { id: 'project-1', name: "Newtab product", visibility: 'private', page_count: 2 },
  ...
  it('renders the project sidebar with counts and actions', () => {
    ...
    expect(sidebar.textContent).toContain("Newtab product");
    ...
    expect(sidebar.querySelector('.project-action-rename[aria-label="Rename Newtab product"]')).not.toBeNull();
  ...
  it('renders the project editor with assigned projects and matching options', () => {
    ...
    expect(dialog.textContent).toContain("Newtab product");
